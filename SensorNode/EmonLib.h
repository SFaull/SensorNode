...
class EnergyMonitor
{
  public:
    // added by Sam Faull
    void setAdcResolution(unsigned int _resolution);
    void setReadCallback(unsigned int(*callback)());
  ...
  private:
    // added by Sam Faull
    unsigned int (*readCallback)(void);
    ...
    //--------------------------------------------------------------------------------------
    int32_t sampleV;                        //sample_ holds the raw analog read value
    int32_t sampleI;
